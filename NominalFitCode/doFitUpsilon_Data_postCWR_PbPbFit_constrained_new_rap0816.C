...
void doFitUpsilon_Data_postCWR_PbPbFit_constrained_new_rap0816(
       int collId = kAADATA,  
       float ptLow=0, float ptHigh=30, 
       float yLow=0.8, float yHigh=1.6,
       ...
       int FixParm_seed=2  )
{
  ...
  RooRealVar    sigma1s_1("sigma1s_1","width/sigma of the signal gaussian mass PDF",0.04, 0.01, 0.27);
