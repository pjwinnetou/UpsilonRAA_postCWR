...
void doFitUpsilon_Data_postCWR_PbPbFit_constrained_new_pt04(
       int collId = kAADATA,  
       ...
       int FixParm_seed=2  )
{
  ...
  RooRealVar    sigma1s_1("sigma1s_1","width/sigma of the signal gaussian mass PDF",0.03, 0.01, 0.2);
  ...
  RooRealVar err_mu("#mu","err_mu",init_mu,  0, 15) ;
