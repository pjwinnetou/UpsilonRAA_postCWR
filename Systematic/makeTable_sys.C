...
void makeTable_sys(int state = 2)
{
  //TFile *wf = new TFile(Form("../acceptance/sys_acceptance_ups%dS_1804.root",state),"read");
  //TFile *wf = new TFile(Form("SignalVariation_PostCWR/Constrain_signalPDFVariaion_%ds.root",state),"read");
  //TFile *wf = new TFile(Form("/home/deathold/work/CMS/analysis/Upsilon_RAA/upsilonRAA_postCWR/UpsilonRAA_postCWR_altpT/Systematic/SignalVariation_PostCWR/Constrain_signalPDFVariaion_%ds.root",state),"read");
  TFile *wf = new TFile(Form("SignalVariation/Constrain_signalPar_%ds.root",state),"read");
  //TFile *wf = new TFile(Form("/home/deathold/work/CMS/analysis/Upsilon_RAA/upsilonRAA_postCWR/UpsilonRAA_postCWR_altpT/Systematic/SignalVariation/Constrain_signalPar_%ds.root",state),"read");
  //TFile *wf = new TFile(Form("BkgVariation_PostCWR/Constrain_bkgPDFVariaion_linear_%ds.root",state),"read");
  //TFile *wf = new TFile(Form("/home/deathold/work/CMS/analysis/Upsilon_RAA/upsilonRAA_postCWR/UpsilonRAA_postCWR_altpT/Systematic/BkgVariation_PostCWR/Constrain_bkgPDFVariaion_4th_%ds.root",state),"read");
  //TFile *wf = new TFile(Form("BkgVariation_PostCWR/Constrain_bkgPDFVariaion_4th_%ds.root",state),"read");
...
cout << "Inegrated                           & " << Form("%.2f",1.00*double(hIntPP->GetBinContent(1)*100)) << "                  & " << Form("%.2f",1.00*double(hIntAA->GetBinContent(1)*100)) << " & " << Form("%.3f",1.00*double(hIntAAoPP->GetBinContent(1)*100)) << "     hline" << endl;
