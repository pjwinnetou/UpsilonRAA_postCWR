...
void getEfficiencyUpsilon_new(int state = 3, bool useDataWeight=true, 
  ...
  if ( state == 1) { 
    ...
    fWgtAA -> SetParameters(parm_AA_nom[0],parm_AA_nom[1],parm_AA_nom[2],parm_AA_nom[3] );
    fWgtPP -> SetParameters(parm_PP_nom[0],parm_PP_nom[1],parm_PP_nom[2],parm_PP_nom[3] );
  }
  else if ( state == 2 ) { 
  ...
  cout << "fWgtPP Par 1 : " << fWgtPP->GetParameter(1)  << endl;  
  cout << "fWgtAA Par 1 : " << fWgtAA->GetParameter(1)  << endl;  
