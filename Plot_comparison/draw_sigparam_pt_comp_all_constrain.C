...
int draw_sigparam_pt_comp_all_constrain(TString szAA = "PP", int states =1, int DrawOpt = 0, int nFit=3) 
{
  setTDRStyle();
...
*/
  ...
  //// binning setting
  /////////////////////////////////////////////////////////
  double tmpArr1s[7] = {0, 2, 4, 6, 9, 12, 30};
  double tmpArr2s[4] = {0, 4, 9, 30};
  double tmpArr3s[3] = {0, 6, 30};
  ...
  for (int ib =0; ib < nBin; ib ++ ) {
    for(int ifit = 0; ifit < nFit; ifit++){
      //// read files
      if (szAA == "PP" ) { 
        if(ifit==0) {fileIn[ifit][ib]= new TFile(Form("%sPAS_fitresults_upsilon_DoubleCB_%s_DATA_pt%.1f-%.1f_y0.0-2.4_muPt4.0.root",fileLoc[ifit].Data(),szAA.Data(),binArr[ib],binArr[ib+1]));}
        else if(ifit!=0) {fileIn[ifit][ib]= new TFile(Form("%sfitresults_upsilon_fixParm1_seed2_DoubleCB_%s_DATA_pt%.1f-%.1f_y0.0-2.4_muPt4.0.root",fileLoc[ifit].Data(),szAA.Data(),binArr[ib],binArr[ib+1]));}
      }
      else if (szAA == "AA" ) { 
        if(ifit==0) {fileIn[ifit][ib]= new TFile(Form("%sPAS_fitresults_upsilon_DoubleCB_%s_DATA_pt%.1f-%.1f_y0.0-2.4_muPt4.0_centrality0-200_dphiEp_0.00PI_100.00PI.root",fileLoc[ifit].Data(),szAA.Data(),binArr[ib],binArr[ib+1]));}
        else if(ifit!=0) {fileIn[ifit][ib]= new TFile(Form("%sfitresults_upsilon_fixParm1_seed2_DoubleCB_%s_DATA_pt%.1f-%.1f_y0.0-2.4_muPt4.0_centrality0-200_dphiEp_0.00PI_100.00PI.root",fileLoc[ifit].Data(),szAA.Data(),binArr[ib],binArr[ib+1]));}
      }
  ...
  for(int ifit=0; ifit<nFit; ifit++){
    ...
    h1_sigma[ifit] = new TH1D(Form("h1_sigma%ds_%d",states,ifit+1),Form("h1_sigma%d;p_{T} (GeV/c);#sigma",states),nBin,binArr); 
  ...
  g_sigma[0]->SetMaximum(valmax[2]*4);
  g_f[0]->SetMinimum(0);
  g_f[0]->SetMaximum(valmax[3]*3);
  g_x[0]->SetMinimum(0);
  g_x[0]->SetMaximum(valmax[4]*2);

  g_alpha[0]->GetXaxis()->SetTitle("p_{T}^{#varUpsilon} (GeV/c)");
  g_alpha[0]->GetYaxis()->SetTitle("#alpha");
  g_n[0]->GetXaxis()->SetTitle("p_{T}^{#varUpsilon} (GeV/c)");
  g_n[0]->GetYaxis()->SetTitle("n");
  g_sigma[0]->GetXaxis()->SetTitle("p_{T}^{#varUpsilon} (GeV/c)");
  g_sigma[0]->GetYaxis()->SetTitle("#sigma");
  g_f[0]->GetXaxis()->SetTitle("p_{T}^{#varUpsilon} (GeV/c)");
  g_f[0]->GetYaxis()->SetTitle("f");
  g_x[0]->GetXaxis()->SetTitle("p_{T}^{#varUpsilon} (GeV/c)");
  ...
  g_alpha[0]->GetXaxis()->SetLimits(0,30);
  g_n[0]->GetXaxis()->SetLimits(0,30);
  g_f[0]->GetXaxis()->SetLimits(0,30);
  g_x[0]->GetXaxis()->SetLimits(0,30);
  g_sigma[0]->GetXaxis()->SetLimits(0,30);
...
*/
  ...
  c_alpha->SaveAs(Form("sigparam_all/Constrain_pt_alpha_Upsilon%ds_%s_nFit%d.pdf",states,szAA.Data(),nFit));
...
*/
  ...
  c_n->SaveAs(Form("sigparam_all/Constrain_pt_n_Upsilon%ds_%s_nFit%d.pdf",states,szAA.Data(),nFit));
...
*/
  ...
  c_sigma->SaveAs(Form("sigparam_all/Constrain_pt_sigma_Upsilon%ds_%s_nFit%d.pdf",states,szAA.Data(),nFit));
...
*/
  ...
  c_f->SaveAs(Form("sigparam_all/Constrain_pt_f_Upsilon%ds_%s_nFit%d.pdf",states,szAA.Data(),nFit));
  ...
  */
  ...
  c_x->SaveAs(Form("sigparam_all/Constrain_pt_x_Upsilon%ds_%s_nFit%d.pdf",states,szAA.Data(),nFit));
...
double *getAvg(double avg_alpha, double avg_n , double avg_sigma, double avg_f, double avg_x, int states, TString szAA)
{
  ...
  for (int ib =0; ib < nBin; ib ++ ) {
    //// read files
    if (szAA == "PP" ) fileIn[ib]= new TFile(Form("%sPAS_fitresults_upsilon_DoubleCB_%s_DATA_pt%.1f-%.1f_y0.0-2.4_muPt4.0.root",fileLoc[0].Data(),szAA.Data(),binArr[ib],binArr[ib+1]));
    else if (szAA == "AA" ) fileIn[ib]= new TFile(Form("%sPAS_fitresults_upsilon_DoubleCB_%s_DATA_pt%.1f-%.1f_y0.0-2.4_muPt4.0_centrality0-200_dphiEp_0.00PI_100.00PI.root",fileLoc[0].Data(),szAA.Data(),binArr[ib],binArr[ib+1]));
