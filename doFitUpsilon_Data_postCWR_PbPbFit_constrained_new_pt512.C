...
void doFitUpsilon_Data_postCWR_PbPbFit_constrained_new_pt512(
       int collId = kAADATA,  
       float ptLow=5, float ptHigh=12, 
       ...
       int FixParm_seed=2  )
{
  ...
  RooRealVar err_mu("#mu","err_mu",2.2150e-01,  0, 25) ;
  RooRealVar err_sigma("#sigma","err_sigma", 8.6689, 0,25);
  RooRealVar m_lambda("#lambda","m_lambda",  4.2, 0,25);
