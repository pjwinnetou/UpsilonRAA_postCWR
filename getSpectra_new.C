...
valErr getYield(int state, int collId, float ptLow, float ptHigh, float yLow, float yHigh, int cLow, int cHigh,
  ...
  TFile* inf = new TFile(Form("/home/deathold/work/CMS/analysis/Upsilon_RAA/upsilonRAA_postCWR/UpsilonRAA_postCWR_fixed_nalphax/fitResults/Constrain/fitresults_upsilon_fixParm1_seed2_%sCB_%s.root",SignalCB.Data(),kineLabel.Data()));
