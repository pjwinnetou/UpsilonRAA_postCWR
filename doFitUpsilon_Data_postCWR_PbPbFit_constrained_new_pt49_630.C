...
void doFitUpsilon_Data_postCWR_PbPbFit_constrained_new_pt49_630(
       int collId = kAADATA,  
       ...
       int FixParm_seed=2  )
{
  ...
  RooRealVar err_sigma("#sigma","err_sigma", init_sigma, 0,20);
  RooRealVar m_lambda("#lambda","m_lambda",  init_lambda, 0,20);
