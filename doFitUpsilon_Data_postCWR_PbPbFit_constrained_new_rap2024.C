...
void doFitUpsilon_Data_postCWR_PbPbFit_constrained_new_rap2024(
       int collId = kAADATA,  
       float ptLow=0, float ptHigh=30, 
       float yLow=2.0, float yHigh=2.4,
       ...
       int FixParm_seed=2  )
{
  ...
  RooRealVar    sigma1s_1("sigma1s_1","width/sigma of the signal gaussian mass PDF",0.05, 0.01, 0.35);
